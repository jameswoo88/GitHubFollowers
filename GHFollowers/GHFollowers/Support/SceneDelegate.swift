...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createNavigationControllers() -> [UINavigationController] {
        ...
        return [UINavigationController(rootViewController: searchVC), UINavigationController(rootViewController: favoriteListVC)]
    }
    ...
    func createTabbar() -> UITabBarController {
        ...
        tabbar.viewControllers                = createNavigationControllers()
